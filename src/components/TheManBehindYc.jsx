...
<section className="relative bg-black text-white py-12 px-6 md:px-16">
                <div className="absolute bottom-104 right-0 opacity-80">
  ...
  <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-8">
    ...
    <div className="w-2/3 space-y-4">
      ...
      <p className='!text-lg'>
        I’m <span className=" !text-lg text-yellow-400">Gurmeet Singh</span> — author of <em>The Articulate Mind</em> and founder of the YC Cohort.
      </p>
      
      <p className='!text-lg'>
        Over the past few years, I’ve worked with founders, creators, and high-performers across India and the US, helping them master the way they speak, write, and lead. I’ve studied communication not just as a skill, but as leverage—the one thing that amplifies everything else you do.
      </p>
