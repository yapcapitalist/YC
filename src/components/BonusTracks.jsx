...
const BonusTracks = () => {
    return (
        <section className="relative pb-12 sm:pb-[158px] px-6 sm:px-4 max-w-6xl mx-auto w-full">
            ...
            <div className="text-center bg-[#131012] border border-gray-600 rounded-xl p-6 sm:p-4 ">
                <h2 className="mb-6 text-[#fefe00]">
                    Bonus Tracks (Chosen By You)
                </h2>
                <p className="mb-8">
                    You’ll get access to optional bonus sessions, based on what the group wants to master:
                </p>

                <ul className="text-left text-white flex justify-centeritems-center flex-col sm:block space-y-4 mb-8  list-inside max-w-3xl mx-auto">
                    <li className='flex jsutify-center items-center  gap-2  border border-[#fefe00] rounded-[4px] w-[280px] p-4'>
                        <span className="mt-2 sm:mt-0 text-yellow-400">
                    ...
                    <li className='flex jsutify-center items-center gap-2 border border-[#fefe00] rounded-[4px] w-[280px] p-4'><span className="mt-2 sm:mt-0 text-yellow-400"><svg className="checksvg" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M26.25 8.7498L11.25 23.7498L4.375 16.8748L6.1375 15.1123L11.25 20.2123L24.4875 6.9873L26.25 8.7498Z" fill="#FEFE00" />
                    </svg>
