...
const RefundCancelation = () => {
    return (
        <div className='max-w-6xl mx-auto px-4 py-8 text-sm leading-relaxed text-white'>
            ...
            <div>
                <p> <span className='font-bold'>1</span>If you are not satisfied after two sessions, we offer a 100% full refund—no questions asked.</p>
                <p><span className='font-bold'>2</span>Refund requests must be submitted in writing within a day of the second session.</p>
                <p><span className='font-bold'>3</span>Beyond this point, refunds are not available, but we’ll do our best to support you with alternatives.</p>
            </div>
        </div>
    )
}
