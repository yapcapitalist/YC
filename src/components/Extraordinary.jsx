    ...
    return (
        <div className="relative  flex items-center justify-center pb-[152px] max-w-6xl mx-auto ">
            {/* <div className="absolute bottom-110 right-0 opacity-80">
              ...
              <div className="absolute grid-svg !w-2/3 top-[128px] right-[-244px] !z-0">
            ...
            <div className="relative text-center space-y-4 z-1">
                <h2 className="">
                ...
                <div className="pt-2 max-w-4xl mx-auto">
                    <p className="!text-[#ababab]"> It's not the vocal training that makes you rich —It's the ability to express, influence, and sell that separates the elite from the average.</p>
                </div>

                <p className=" !text-[#ababab] pt-2 max-w-4xl mx-auto">
