...
export default function Extraordinary() {
  ...
  return (
    <section className="relative maincon container flex items-center max-w-6xl mx-auto justify-center pb-12 sm:pb-[158px] px-4 sm:px-0">
      ...
      <div className="relative text-center space-y-4 z-1 w-full">
        <h2 className="text-xl sm:text-3xl font-semibold leading-snug">
          Extraordinary claims require extraordinary evidence.
        </h2>

        <div className="relative z-1 py-10 sm:py-16 text-center max-w-6xl mx-auto">
          {/* Main Video */}
          <div className="main-video-container mx-auto" style={{
            width: "100%",
            maxWidth: 850,
            aspectRatio: "14/7",
            borderRadius: 12,
          ...
          <div className="thumbnail-slider-container mt-6 sm:mt-12 overflow-hidden">
            <div className="thumbnail-slider flex gap-4 w-fit animate-[slideLeft_28s_linear_infinite] px-2 sm:px-0">
              {[...youtubeVideoIds, ...youtubeVideoIds].map((videoId, i) => (
                <div
                  key={i}
                  className="thumbnail-video-item relative cursor-pointer bg-[#111] transition-all"
                  style={{
                    flexShrink: 0,
                    width: "240px",
                    height: "140px",
                    borderRadius: "12px",
                    overflow: "hidden",
                    border: mainVideoId === videoId ? "2px solid #ffff00" : "1px solid #444",
        ...
        {/* Paragraphs */}
        <div className="max-w-4xl mx-auto space-y-2 text-sm sm:text-base text-[#ababab] px-4 sm:px-0">
          ...
          <p>You master that, you print money.</p>
        </div>
      </div>
